### Brook trout YOY abundance model for GSMNP (SMOK) adapted from Kanno et al. (2016) Freshwater Biology
...
save(out1, out2, file="ResultsRaw_YOY_SMOK_3Feb16.RData")
...
save(N.est, y.est, file="Result_YOYEst_SMOK_3Feb16.RData")
# gelman.diag(out1)

#########################################################
# Plot histograms for seasonal climate covariates
pdf("Result_EnvHist_YOY_SMOK_3Feb16.pdf")
