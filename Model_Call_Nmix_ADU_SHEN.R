### Brook trout ADULT abundance model for SHEN adapted from Kanno et al. (2016) Freshwater Biology
...
save(out1, out2, file="ResultsRaw_ADU_SHEN_3Feb16.RData")
...
save(N.est, y.est, file="Result_ADUEst_SHEN_3Feb16.RData")
# gelman.diag(out1)

#########################################################
# Plot histograms for seasonal climate covariates
pdf("Result_EnvHist_ADU_SHEN_3Feb16.pdf")
